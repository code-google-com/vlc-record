/*=============================================================================\
| $HeadURL: https://vlc-record.googlecode.com/svn/trunk/vlc-record/ckartinaclnt.cpp $
|
| Author: Jo2003
|
...
|
| $Id: ckartinaclnt.cpp 1100 2013-06-05 10:15:31Z Olenka.Joerg $
|
\=============================================================================*/
...
void CNovoeClient::GetChannelList (const QString &secCode)
{
   ...
   QString req   = "have_sepg=1";
   QString sFile = "channel_list.php";

   if (secCode != "")
   {
      // normal channel list request ...
       req   = "";
       sFile = "get_channels_order.php";
   }
   ...
   q_get((secCode == "") ? (int)CIptvDefs::REQ_CHANNELLIST : (int)CIptvDefs::REQ_CHANLIST_ALL,
         sApiUrl + sFile + QString("?") + req + QString("&") + sCookie);
}
