...
public slots:
   ...
   void revert();
   void rollback(const QKeySequence &seq);

signals:
   void keySequenceChanged(const QKeySequence &currSeq, const QKeySequence &orgSeq, int row);
   void emptyFocusOut(const QKeySequence &currSeq, const QKeySequence &orgSeq, int row);
...
private:
   ...
   QKeySequence m_currkeySequence;
   QKeySequence m_undokeySequence;
