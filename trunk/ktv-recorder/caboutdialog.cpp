...
void CAboutDialog::FillInfo(QString sExpires)
{
   ...
   str << "<style type='text/css'>" << endl
         ...
         << QString("<tr><td><b>SDK:</b></td><td style='padding-left: 15px;'>Qt %2 by <a href='http://qt-project.org'>Digia</a></td></tr>").arg(qVersion()) << endl
         ...
         << "</table><br /> <br />" << endl
         << tr("<b>KTV-Recorder is free software!</b>") << endl
