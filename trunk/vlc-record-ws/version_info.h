...
#define __MY__VERSION__ \
   VERSION_MAJOR ".35beta" VERSION_APPENDIX " - " MY_BUILD_SYS ", built at " __DATE__

#endif /* __011910__VERSION_INFO_H */
/************************* History ***************************\
| --- new since last version ---
| 2010-07-13: Version x.35beta (for test only)
| - backport to use old libVLC1.05
| - watch the log for receiving first oicture to then
|   set aspect and crop
|
